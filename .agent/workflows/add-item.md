---
description: Add a new consumable item that affects survival stats
migrated: .claude/commands/add-item.md
---

> **Migrated to `.claude/commands/add-item.md`.** Use `/add-item` in Claude Code.

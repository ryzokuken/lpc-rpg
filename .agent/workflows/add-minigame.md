---
description: Create a new mini-game following existing patterns
migrated: .claude/commands/add-minigame.md
---

> **Migrated to `.claude/commands/add-minigame.md`.** Use `/add-minigame` in Claude Code.

// turbo-all

# Add New Mini-game Workflow
...
var player_skill: int = 5  # Inject relevant player stat
...
## Call from _process to update game state
...
Option A: Trigger via interaction spot
```gdscript
# In interaction_spot.gd or similar
...
Option B: Trigger via menu/item
